...
const SERVER_URL = 'https://free.uazapi.com/v2';
...
async function checkV2() {
  try {
    ...
    console.log('V2 info:', JSON.stringify(response.data, null, 2));
  } catch (error: any) {
    console.error('V2 error:', error.response?.data || error.message);
  }
}
