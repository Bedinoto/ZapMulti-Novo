...
// Hardcoded Database URL for Hostinger - Using 127.0.0.1 for better compatibility
const dbUrl = process.env.DATABASE_URL || "mysql://u801415719_zapapi:+5mNmLbAjF@127.0.0.1:3306/u801415719_zapapi";
